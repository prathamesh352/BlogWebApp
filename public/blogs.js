exports.allBlogs = [
    {
      ...
      category: "Technology",
      content:
        "Broad professional category covering functions including building communications networks.",
    },
    {
      id: 2,
      ...
      category: "Health",
      content:
        "Healthy eating and drinking, Giving up smoking, Get plenty of fresh air, Keeping physically active.Be socially active.",
    },
    {
      id: 3,
      ...
      category: "Travel",
      content:
        "Trekking in the Everest Region is some of the most beautiful in the world, and getting there is an adventure of its own.",
    },
    {
      id: 4,
      ...
      category: "DIY",
      content:
        "TDIY Scrub-Ology Patterns,DIY Felt Garlands.DIY Floral Garlands,DIY Cotton & Fur Projects,DIY Glass Vase Projects.",
    },
    {
      id: 5,
      ...
      category: "Fashion",
      content:
        "Dress Like a Debutant, Swathes of Fabric, Burgundy Bags, Cardigan Club, Barrel Silhouettes, Khaki Comeback.",
    },
    {
      id: 6,
    ...
    {
      id: 8,
      img: "/images/blogs/S1.jpg",
      title: "A human activity involving physical exertion. ",
      category: "Sport",
      content:
        "Physical activity refers to all movement. Popular ways to be active include walking, cycling, wheeling, sports.",
    },
    {
      id: 9,
    ...
    },
    {
      ...
      title: " Physical and mental skill-intensive exercises.",
      category: "Sport",
      content:
        "It is recommended that the average adult should do between 75 and 150 minutes of exercise a week. ",
    },
    {
      id: 18,
    ...
    },
    {
      ...
      category: "Lifestyle",
      content:
        "Without growth, and without a deliberate effort to help others, we are simply slaves to cultural expectations ensnared by the trappings of money, power, status, and perceived success.",
    },
